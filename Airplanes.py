...
os_names = [
    "Boeing 737", "Airbus A320", "Boeing 787 Dreamliner", "Boeing 747", "Airbus 380", "F16",
    "F22", "B52", "C130", "Cessna 172 Skyhawk", "Gulfstream G650", "Antonov An-225 Mriya"
]
...
def draw_os_clock():
    ...
    # Title and legend
    ax.set_title("Airplanes Clock", fontsize=14, weight='bold')
